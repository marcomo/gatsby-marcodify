...
<Grid lgrows={1} lgcolumns={2} mdrows={2} mdcolumns={1} className="my-max">
  ...
  <div className="gridarea-2">
    ...
    - Quickly replace large parts of a playlist with a specific artist
    - Create variety in playlists by replacing large parts with selections from the explore panel
