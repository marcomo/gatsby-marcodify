...
The purpose of this project was to redesign the universal navigation model and interface so that users would have easier access to and a better mental model of the product family.
...
and differentiate products. Another frustration heard was that users couldn't see other product grouping menus
