...
The purpose of this project was to redesign the universal navigation model and interface so that users have easier access and a better mental model of our product family.
...
<Grid rows={1} columns={2} className="cols-60-40">
  ...
  <div className="gridarea-2">
    ...
    - Commits to a common language for names that we can display on products and features
