...
<Grid dtrows={1} dtcolumns={2} mbrows={2} mbcolumns={1} className="cols-30-70 rows-70-30 mobile-images">
...
<div className="flex-column flex-item">
  ...
  <div className="flex-row flex-item align-center">
...
<Grid dtrows={1} dtcolumns={2} mbrows={2} mbcolumns={1} className="cols-40-60 my-max">
  <div className="gridarea-2">
...
<Grid dtrows={1} dtcolumns={2} mbcolumns={1} mbrows={2} className="cols-60-40">
  <div className="gridarea-1">
